...
//    ui.plot_plot->setBackgroundColor(Qt::white);
    ui.plot_plot->setBackgroundColor(Qt::black);
//    ui.plot_plot->setForegroundColor(Qt::black);
    ui.plot_plot->setForegroundColor(Qt::white);
    updatePlot();
  ...
  void TabPlot::plotTrends()
  {
    ...
    m_plotObject = new PlotObject (Qt::yellow, PlotObject::Points, 4, PlotObject::Triangle);
