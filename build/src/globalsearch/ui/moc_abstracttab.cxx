...
static const char qt_meta_stringdata_GlobalSearch__AbstractTab[] = {
    "GlobalSearch::AbstractTab\0\0"
    "moleculeChanged(GlobalSearch::Structure*)\0"
    "startingBackgroundProcessing()\0"
    "finishedBackgroundProcessing()\0"
    "initialized()\0lockGUI()\0filename\0"
    "readSettings(QString)\0readSettings()\0"
    "writeSettings(QString)\0writeSettings()\0"
    "updateGUI()\0disconnectGUI()\0initialize()\0"
    "setBusyCursor()\0clearBusyCursor()\0"
};
