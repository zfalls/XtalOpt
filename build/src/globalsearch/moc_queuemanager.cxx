...
**
** Created: Fri Feb 7 13:46:04 2014
...
static const char qt_meta_stringdata_GlobalSearch__QueueManager[] = {
    "GlobalSearch::QueueManager\0\0"
    "movedToQMThread()\0s\0"
    "structureStarted(GlobalSearch::Structure*)\0"
    "structureSubmitted(GlobalSearch::Structure*)\0"
    ...
    "needNewStructure()\0optimized,running,failing\0"
    "newStatusOverview(int,int,int)\0reset()\0"
    "killStructure(Structure*)\0"
    "appendToJobStartTracker(Structure*)\0"
    "requests\0addManualStructureRequest(int)\0"
    "addManualStructureRequest()\0"
    "QList<Structure*>\0getAllRunningStructures()\0"
    "getAllOptimizedStructures()\0"
    "getAllDuplicateStructures()\0"
    "getAllStructures()\0lockForNaming()\0"
    "unlockForNaming(Structure*)\0"
    "unlockForNaming()\0checkLoop()\0s,optStep\0"
