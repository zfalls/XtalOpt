...
#include "../../../src/globalsearch/tracker.h"
...
static const char qt_meta_stringdata_GlobalSearch__Tracker[] = {
    "GlobalSearch::Tracker\0\0s\0"
    "newStructureAdded(GlobalSearch::Structure*)\0"
    "c\0structureCountChanged(int)\0"
};
...
const QMetaObjectExtraData GlobalSearch::Tracker::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject GlobalSearch::Tracker::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_GlobalSearch__Tracker,
      qt_meta_data_GlobalSearch__Tracker, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &GlobalSearch::Tracker::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_GlobalSearch__Tracker))
