...
**
** Created: Thu Feb 6 09:52:10 2014
...
static const char qt_meta_stringdata_GlobalSearch__OptBase[] = {
    "GlobalSearch::OptBase\0\0startingSession()\0"
    "sessionStarted()\0readOnlySessionStarted()\0"
    "queueInterfaceChanged(QueueInterface*)\0"
    "optimizerChanged(Optimizer*)\0s\0"
    "debugStatement(QString)\0"
    "warningStatement(QString)\0"
    "errorStatement(QString)\0message,ok\0"
    "needBoolean(QString,bool*)\0"
    "message,newPassword,ok\0"
    "needPassword(QString,QString*,bool*)\0"
    "refreshAllStructureInfo()\0text\0"
    "sig_setClipboard(QString)\0reset()\0"
    "bool\0createSSHConnections()\0startSearch()\0"
    ...
    "q\0setQueueInterface(QueueInterface*)\0"
    "o\0setOptimizer(Optimizer*)\0"
    "promptForBoolean(QString,bool*)\0message\0"
    "promptForBoolean(QString)\0"
    "promptForPassword(QString,QString*,bool*)\0"
    "message,newPassword\0"
    "promptForPassword(QString,QString*)\0"
    "setClipboard(QString)\0setClipboard_(QString)\0"
