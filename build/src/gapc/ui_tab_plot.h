...
**
** Created: Wed Dec 18 13:40:00 2013
...
public:
    ...
    void setupUi(QWidget *Tab_Plot)
    {
        ...
        combo_distHistPC = new QComboBox(gb_distance);
        combo_distHistPC->setObjectName(QString::fromUtf8("combo_distHistPC"));

        gridLayout_4->addWidget(combo_distHistPC, 0, 1, 1, 1);
        ...
        label_2->setBuddy(combo_distHistPC);
