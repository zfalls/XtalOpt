...
public:
    ...
    void setupUi(QWidget *Tab_Progress)
    {
        ...
        if (table_list->columnCount() < 7)
            table_list->setColumnCount(7);
    ...
    void retranslateUi(QWidget *Tab_Progress)
    {
        ...
        ___qtablewidgetitem6->setText(QApplication::translate("Tab_Progress", "Ancestry", 0, QApplication::UnicodeUTF8));
