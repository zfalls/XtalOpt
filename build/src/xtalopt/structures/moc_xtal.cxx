...
**
** Created: Mon Mar 17 17:48:26 2014
...
static const char qt_meta_stringdata_XtalOpt__Xtal[] = {
    "XtalOpt::Xtal\0\0dimensionsChanged()\0"
    "A,B,C,Alpha,Beta,Gamma\0"
    "setCellInfo(double,double,double,double,double,double)\0"
    "m\0setCellInfo(OpenBabel::matrix3x3)\0"
    "v1,v2,v3\0"
    "setCellInfo(OpenBabel::vector3,OpenBabel::vector3,OpenBabel::vector3)\0"
    "Volume\0setVolume(double)\0"
    "a,b,c,alpha,beta,gamma\0"
    "rescaleCell(double,double,double,double,double,double)\0"
    "bool\0attempts\0fixAngles(int)\0fixAngles()\0"
    "wrapAtomsToCell()\0prec\0findSpaceGroup(double)\0"
    "findSpaceGroup()\0"
};
