...
**
** Created: Sat Mar 29 11:16:10 2014
...
public:
    ...
    void setupUi(QWidget *Tab_Opt)
    {
        ...
        sizePolicy2.setHeightForWidth(spin_numInitial->sizePolicy().hasHeightForWidth());
        spin_numInitial->setSizePolicy(sizePolicy2);
        ...
        sizePolicy4.setHeightForWidth(push_addSeed->sizePolicy().hasHeightForWidth());
        push_addSeed->setSizePolicy(sizePolicy4);
        ...
        sizePolicy4.setHeightForWidth(push_removeSeed->sizePolicy().hasHeightForWidth());
        push_removeSeed->setSizePolicy(sizePolicy4);
        ...
        sizePolicy4.setHeightForWidth(spin_failLimit->sizePolicy().hasHeightForWidth());
        spin_failLimit->setSizePolicy(sizePolicy4);
        ...
        gridLayout_5->addWidget(label_41, 5, 0, 1, 1);
        ...
        spin_tol_spg->setDecimals(6);
        spin_tol_spg->setSingleStep(0.0005);
        ...
        QWidget::setTabOrder(spin_strip_per2, spin_p_perm);
...
#ifndef QT_NO_TOOLTIP
        spin_numInitial->setToolTip(QApplication::translate("Tab_Opt", "Number of initial structures to use in first generation.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        label_41->setText(QApplication::translate("Tab_Opt", "Final number of structures:", 0, QApplication::UnicodeUTF8));
