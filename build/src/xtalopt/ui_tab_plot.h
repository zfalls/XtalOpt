...
**
** Created: Fri Feb 7 15:14:47 2014
...
public:
    ...
    void setupUi(QWidget *Tab_Plot)
    {
        ...
        cb_showIAD = new QCheckBox(gb_trend);
        cb_showIAD->setObjectName(QString::fromUtf8("cb_showIAD"));

        gridLayout_3->addWidget(cb_showIAD, 4, 0, 1, 2);

        cb_labelPoints = new QCheckBox(gb_trend);
        cb_labelPoints->setObjectName(QString::fromUtf8("cb_labelPoints"));

        gridLayout_3->addWidget(cb_labelPoints, 5, 0, 1, 1);

        combo_labelType = new QComboBox(gb_trend);
        combo_labelType->setObjectName(QString::fromUtf8("combo_labelType"));

        gridLayout_3->addWidget(combo_labelType, 5, 1, 1, 1);
        ...
        gridLayout_2->addWidget(gb_distance, 6, 0, 1, 2);
    ...
    void retranslateUi(QWidget *Tab_Plot)
    {
        ...
        cb_showIAD->setText(QApplication::translate("Tab_Plot", "Show structures which violate &IAD constraints", 0, QApplication::UnicodeUTF8));
