...
public:
    ...
    QLabel *label_2;
    QComboBox *combo_distHistStructure;
    ...
    void setupUi(QWidget *Tab_Plot)
    {
        ...
        combo_distHistStructure = new QComboBox(gb_distance);
        combo_distHistStructure->setObjectName(QString::fromUtf8("combo_distHistStructure"));

        gridLayout_4->addWidget(combo_distHistStructure, 0, 1, 1, 1);
        ...
        label_2->setBuddy(combo_distHistStructure);
    ...
    void retranslateUi(QWidget *Tab_Plot)
    {
        ...
        combo_labelType->insertItems(0, QStringList()
         << QApplication::translate("Tab_Plot", "Index", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("Tab_Plot", "Energy (eV)", 0, QApplication::UnicodeUTF8)
        );
